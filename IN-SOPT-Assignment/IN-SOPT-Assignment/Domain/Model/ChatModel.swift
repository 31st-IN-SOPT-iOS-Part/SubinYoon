...
extension ChatModel {
    static var sampleData: [ChatModel] {
        return [
            ChatModel(profileImage: ImageLiterals.profileImg1, userName: "김솝트", message: "메시지좀 봐줄래?", time: "2022-11-01 16:30"),
            ChatModel(profileImage: ImageLiterals.profileImg2, userName: "이솝트", message: "선물과 메시지를 보냈습니다.", time: "2022-11-03 11:20"),
            ChatModel(profileImage: ImageLiterals.profileImg3, userName: "박솝트", message: "자니?", time: "2022-11-02 01:00"),
            ...
            ChatModel(profileImage: ImageLiterals.profileImg7, userName: "조솝트", message: "ㅇㅋㅇㅋ", time: "2022-11-01 09:00"),
            ChatModel(profileImage: ImageLiterals.profileImg8, userName: "윤솝트", message: "과제 다했어?", time: "2022-11-02 20:40"),
            ChatModel(profileImage: ImageLiterals.profileImg9, userName: "장솝트", message: "어디야?", time: "2022-11-01 11:30"),
            ChatModel(profileImage: ImageLiterals.profileImgSample, userName: "임솝트", message: "안녕하세요.", time: "2022-11-03 10:00"),
